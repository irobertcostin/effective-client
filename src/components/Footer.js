...
export default function Footer({ home }) {
    ...
    return (
        <footer className="w-full relative bg-black border border-black flex flex-col justify-between py-4 px-4 overflow-hidden">
            ...
            <div className="w-full text-white z-50 flex flex-col gap-10 py-5   xl:flex-row xl:justify-center xl:items-start">
                ...
                <div className="w-full  flex flex-col xl:max-w-[300px] ">
                    ...
                    <div className="w-full flex px-5 gap-10 py-10 justify-center xl:justify-start xl:px-0">
                        ...
                        <a href="https://www.facebook.com/effectivemediaro" target="_blank" className="  text-neutral-600 dark:text-neutral-200">
                            <img className="h-12 w-12" src={fbook}></img>
                        </a>



                        <a href="https://www.instagram.com/effectivemedia.ro/" target="_blank" className=" text-neutral-600 dark:text-neutral-200">
                            <img className="h-12 w-12" src={insta}></img>
                        </a>

                        <a href="https://linkedin.com/company/effective-media-ro/" target="_blank" className=" text-neutral-600 dark:text-neutral-200">
                            <svg color="" enableBackground="new 0 0 56.693 56.693" id="Layer_1" version="1.1" viewBox="0 0 56.693 56.693" className="h-12 w-12  text-white" xmlns="http://www.w3.org/2000/svg">
                                <g>
