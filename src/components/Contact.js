    ...
    return (
        <div ref={contact} className="isolate bg-white px-6 py-16 lg:px-8 relative z-40">
            ...
            <div className="mx-auto max-w-2xl text-center">
                <div className="text-5xl font-bold tracking-tight text-gray-900   bg-gradient-to-r from-indigo-600 to-pink-400 bg-clip-text text-transparent">
                    <TypeAnimation
                        sequence={[
                            'Get',
                            500,
            ...
            <div className='w-full xl:flex  justify-center items-start xl:px-40 xl:gap-20 '>
                ...
                <div className='mx-auto mt-16 max-w-xl sm:mt-20  xl:max-w-5xl xl:w-full'>
                    <div className=' flex flex-col justify-center items-center gap-10  rounded-lg py-16 bg-gradient-to-tr from-violet-500 to-orange-300'>
                        <p className='w-full text-center text-4xl text-white px-4'>Contact our representative</p>
                        <div className='flex flex-col gap-2'>
                            ...
                            <button onClick={handleWhatsAppButtonClick} className='flex justify-center items-center gap-2 bg-slate-800 py-2 px-10 hover:bg-opacity-50 text-white rounded-full text-xl'>
                    ...
                    <div className='w-full flex flex-col gap-4 justify-center items-center my-10 xl:pb-8 xl:border-2 border-fuchsia-500 rounded-lg'>
                        <p className='w-full text-center xl:mt-16 text-2xl xl:text-4xl text-indigo-800'>Or submit this form</p>
